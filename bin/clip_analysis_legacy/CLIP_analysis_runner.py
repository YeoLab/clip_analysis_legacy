...
from bin.clip_analysis_legacy.CLIP_analysis import *
...
def call_main():
    ...
    parser.add_option("--regions_location", dest="regions_location",  help="directory of genomic regions for a species (default: clip_analysis_legacy defined regions)", default=None)
